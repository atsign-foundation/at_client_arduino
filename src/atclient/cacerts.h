...
// GlobalSign Root CA (RSA)
// =========================
// Required to verify the cross-signed GTS Root R1 that Google Trust Services
// includes in TLS chains (e.g. atServer certs issued via WR1 intermediate).
// The cross-signed GTS Root R1 (valid until Jan 28 2028) is signed by this root;
// without it mbedTLS cannot complete the chain from WR1 to a trusted anchor.
